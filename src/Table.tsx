...
const Row = ({ row }: any) => {
  return (
    <tr key={row.id}>
      ...
      <td className={setRisAndFallColor(row.cell.increase_rt)}>{row.cell.increase_rt}%</td>
      <td>{row.cell.stock_nm}</td>
      <td>{row.cell.sprice}</td>
      <td className={setRisAndFallColor(row.cell.sincrease_rt)}>{row.cell.sincrease_rt}%</td>
      <td>{row.cell.pb}</td>
