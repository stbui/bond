    ...
    <>
      <div className="nav">
        {[
          ...
          20220517, 20220518, 20220530, 20220531, 20220601, 20220602, 20220606,
          20220607, 20220608, 20220609, 20220829, 20220830, 20220831, 20220901,
          20220902, 20220905, 20220906, 20221025, 20221026, 20221027,
        ].map((item) => (
          <span
